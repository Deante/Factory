...
describe('Service Tests', () => {
    ...
    describe('Gestionnaire Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GestionnaireService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/gestionnaires';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Gestionnaire', () => {

                let entity: Gestionnaire;
                service.find(123).subscribe((_entity: Gestionnaire) => {
                    entity = _entity;
                });
