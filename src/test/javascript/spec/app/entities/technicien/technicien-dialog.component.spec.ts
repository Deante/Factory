...
import { TechnicienDialogComponent } from '../../../../../../main/webapp/app/entities/technicien/technicien-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Technicien Management Dialog Component', () => {
        let comp: TechnicienDialogComponent;
        let fixture: ComponentFixture<TechnicienDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TechnicienDialogComponent],
                providers: [
                    UserService,
                    TechnicienService
                ]
            })
            .overrideTemplate(TechnicienDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(TechnicienDialogComponent);
