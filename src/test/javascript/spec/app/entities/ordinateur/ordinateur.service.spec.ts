...
describe('Service Tests', () => {
    ...
    describe('Ordinateur Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OrdinateurService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ordinateurs';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Ordinateur', () => {

                let entity: Ordinateur;
                service.find(123).subscribe((_entity: Ordinateur) => {
                    entity = _entity;
                });
