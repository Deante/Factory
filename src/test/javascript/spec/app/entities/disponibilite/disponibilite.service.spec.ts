...
describe('Service Tests', () => {
    ...
    describe('Disponibilite Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DisponibiliteService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/disponibilites';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Disponibilite', () => {

                let entity: Disponibilite;
                service.find(123).subscribe((_entity: Disponibilite) => {
                    entity = _entity;
                });
