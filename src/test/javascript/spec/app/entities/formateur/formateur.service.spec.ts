...
describe('Service Tests', () => {
    ...
    describe('Formateur Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FormateurService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/formateurs';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Formateur', () => {

                let entity: Formateur;
                service.find(123).subscribe((_entity: Formateur) => {
                    entity = _entity;
                });
