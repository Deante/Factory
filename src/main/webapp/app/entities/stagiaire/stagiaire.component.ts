...
export class StagiaireComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Stagiaire) {
        return item.id;
    }
    registerChangeInStagiaires() {
        this.eventSubscriber = this.eventManager.subscribe('stagiaireListModification', (response) => this.reset());
    }
