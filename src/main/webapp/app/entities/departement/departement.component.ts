...
export class DepartementComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.departementService.search({
    ...
    trackId(index: number, item: Departement) {
        return item.id;
    }
    registerChangeInDepartements() {
        this.eventSubscriber = this.eventManager.subscribe('departementListModification', (response) => this.reset());
    }
