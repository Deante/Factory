...
export class ProjecteurComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Projecteur) {
        return item.id;
    }
    registerChangeInProjecteurs() {
        this.eventSubscriber = this.eventManager.subscribe('projecteurListModification', (response) => this.reset());
    }
