...
@Injectable()
export class GestionnairePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.gestionnaireModalRef(component, new Gestionnaire());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    gestionnaireModalRef(component: Component, gestionnaire: Gestionnaire): NgbModalRef {
