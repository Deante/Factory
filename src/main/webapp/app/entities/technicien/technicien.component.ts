...
export class TechnicienComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Technicien) {
        return item.id;
    }
    registerChangeInTechniciens() {
        this.eventSubscriber = this.eventManager.subscribe('technicienListModification', (response) => this.reset());
    }
