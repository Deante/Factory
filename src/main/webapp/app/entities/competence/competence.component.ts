...
export class CompetenceComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Competence) {
        return item.id;
    }
    registerChangeInCompetences() {
        this.eventSubscriber = this.eventManager.subscribe('competenceListModification', (response) => this.reset());
    }
