...
import factory.config.ApplicationProperties;
import factory.config.DefaultProfileUtil;
...
public class FactoryApp {
    ...
    public FactoryApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FactoryApp.class);
